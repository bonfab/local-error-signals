...
class DDTPPureConvLayer(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
                 ...
                 initialization='xavier_normal', forward_activation='tanh',
...
class DDTPConvLayerLast(nn.Module):
    """
    A convolutional layer combined with a pool layer.
    """
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        self._avg_layer = nn.AvgPool2d(pool_kernel_size, pool_stride, pool_padding)
