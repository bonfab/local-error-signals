...
class DDTPConvAllCNNC(DDTPConvNetwork):
...
class DDTPPureConvAllCNNC(DDTPConvNetwork):
    def __init__(self, bias=True, hidden_activation='relu',
                 feedback_activation='linear', initialization='xavier_normal',
                 sigma=0.1, plots=None, forward_requires_grad=False):
        nn.Module.__init__(self)
        l1 = DDTPPureConvLayer(3, 96, (3, 3), 10, [96, 32, 32],
                           stride=1, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
                           feedback_activation=feedback_activation)
        l2 = DDTPPureConvLayer(96, 96, (3, 3), 10, [96, 32, 32],
                           stride=1, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        l3 = DDTPPureConvLayer(96, 96, (3, 3), 10, [96, 16, 16],
                           stride=2, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        l4 = DDTPPureConvLayer(96, 192, (3, 3), 10, [192, 16, 16],
                           stride=1, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
                           feedback_activation=feedback_activation)
        l5 = DDTPPureConvLayer(192, 192, (3, 3), 10, [192, 16, 16],
                           stride=1, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        l6 = DDTPPureConvLayer(192, 192, (3, 3), 10, [192, 8, 8],
                           stride=2, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        l7 = DDTPPureConvLayer(192, 192, (3, 3), 10, [192, 6, 6],
                           stride=1, padding=0, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
                           feedback_activation=feedback_activation)
        l8 = DDTPPureConvLayer(192, 192, (1, 1), 10, [192, 6, 6],
                           stride=1, padding=0, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
...
class DDTPPureShortCNNC_kernelmod(DDTPConvNetwork):
    def __init__(self, bias=True, hidden_activation='relu',
                 feedback_activation='linear', initialization='xavier_normal',
                 sigma=0.1, plots=None, forward_requires_grad=False):
        nn.Module.__init__(self)
        l1 = DDTPPureConvLayer(3, 32, (5, 5), 10, [32, 16, 16],
                           stride=2, padding =2, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
                           feedback_activation=feedback_activation)
        
        l3 = DDTPPureConvLayer(32, 64, (5, 5), 10, [64, 8, 8],
                           stride=2, padding=2, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        l6 = DDTPPureConvLayer(64, 64, (8, 8), 10, [64, 1, 1],
                           stride=1, padding=0, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        #                    forward_activation=hidden_activation,
        #                    feedback_activation=feedback_activation)
        l9 = DDTPConvLayerLast(64, 10, (1, 1), 10, [10,1,1],
                           stride=1, padding=0, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           pool_type='max', pool_kernel_size=(1,1),
        ...
        self._layers = nn.ModuleList([l1,l3, l6, l9])
        self._depth = 4
        self.nb_conv = 4
        self._input = None
        self._sigma = sigma
...
class DDTPPureShortCNNC(DDTPConvNetwork):
    def __init__(self, bias=True, hidden_activation='relu',
                 feedback_activation='linear', initialization='xavier_normal',
                 sigma=0.1, plots=None, forward_requires_grad=False):
        nn.Module.__init__(self)
        l1 = DDTPPureConvLayer(3, 32, (3, 3), 10, [32, 16, 16],
                           stride=2, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        l3 = DDTPPureConvLayer(32, 64, (3, 3), 10, [64, 8, 8],
                           stride=2, padding=1, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
        ...
        l6 = DDTPPureConvLayer(64, 64, (3, 3), 10, [64, 6, 6],
                           stride=1, padding=0, dilation=1, groups=1,
                           bias=bias, padding_mode='zeros',
                           initialization=initialization,
                           forward_activation=hidden_activation,
...
class DDTPPureShortCNNC_DENSE(DDTPConvNetwork):
    def __init__(self, bias=True, hidden_activation='relu',
                 feedback_activation='linear', initialization='xavier_normal',
                 sigma=0.1, plots=None, forward_requires_grad=False):
        nn.Module.__init__(self)
        ...
        #                    forward_activation=hidden_activation,
        #                    feedback_activation=feedback_activation)
        l7 = DDTPMLPLayer(6 * 6 * 64, 512, 10, bias=True,
        ...
        l8 = DDTPMLPLayer(512, 10, 10, bias=True,
                          forward_requires_grad=forward_requires_grad,
        ...
        self._layers = nn.ModuleList([l1,l3, l6, l7, l8])
        self._depth = 5
        self.nb_conv = 3
        self._input = None
        self._sigma = sigma
...
class DDTPConvAllCNNC_dense(DDTPConvNetwork):
    def __init__(self, bias=True, hidden_activation='relu',
                 feedback_activation='linear', initialization='xavier_normal',
                 sigma=0.1, plots=None, forward_requires_grad=False):
        nn.Module.__init__(self)
