...
from lib.conv_networks_AllCNN import DDTPConvAllCNNC, DDTPPureConvAllCNNC, DDTPPureShortCNNC
...
def load_network_w_weights(args, run_dir = "results/acnnc_1000_relu_Adam_Pure_lr.1"):
    ...
    net = DDTPPureShortCNNC(bias=not args.no_bias,
...
if __name__ == "__main__":
    ...
    allCNNC = DDTPPureShortCNNC(bias=not args.no_bias,
                                           hidden_activation=args.hidden_activation,
                                           feedback_activation=args.fb_activation,
                                           initialization=args.initialization,
                                           sigma=args.sigma,
